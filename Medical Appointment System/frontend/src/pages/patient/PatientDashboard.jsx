...
const PatientDashboard = () => {
  ...
  const menuItems = [
    ...
    { icon: History, label: 'Appointments', path: '/patient/appointments' },
    { icon: FileText, label: 'Prescriptions', path: '/patient/prescriptions' },
    { icon: BrainCircuit, label: 'AI Assistant', path: '/patient/ai-assistant' },
  ]
...
>
      {/* Mobile Header */}
      <div className="lg:hidden fixed top-0 left-0 right-0 bg-indigo-600 border-b border-gray-200 z-50">
